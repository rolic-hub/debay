## Debay is an online store where items are purchased in cryptocurrency and the user gets an nft for purchsed items thereby opening the user to more futures on the dapp
